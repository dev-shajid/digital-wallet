        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_transactions_failed_has_reason", "status <> 'FAILED' OR failure_reason IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_wallet_logs_balance_after_non_negative", "balance_after IS NULL OR balance_after >= 0");
                    table.CheckConstraint("ck_wallet_logs_balance_pair", "(balance_before IS NULL) = (balance_after IS NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "currencies",
                columns: new[] { "id", "code", "created_at", "decimal_places", "name", "status", "symbol", "updated_at" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "BDT", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 2, "Bangladeshi Taka", "ACTIVE", "৳", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
